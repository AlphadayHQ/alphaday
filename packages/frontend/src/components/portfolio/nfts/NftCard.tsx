    ...
    return (
        <div className="flex m-[5px]">
            <div className="relative w-[130px] h-[160px] my-0 mx-auto bg-background rounded-md two-col:w-[150px] two-col:h-[200px]">
                ...
                <div className="absolute bottom-0 left-0 w-full flex transition-all duration-500 flex-col items-start justify-start h-10 p-2 rounded-t-[3px] rounded-b-md hover:[filter:brightness(1.1)] hover:h-[50px]">
