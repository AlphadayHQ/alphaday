...
export function SingleOTPInput(props: ISingleOTPInputProps) {
    ...
    return (
        <input
            className={twMerge(
                "rounded text-background text-center w-10 h-12 font-semibold focus:bg-primaryVariant200 bg-primaryVariant200 placeholder-shown:bg-primaryVariant300 placeholder:text-transparent focus:outline-none border-none focus:border-none",
                className
            )}
            ref={inputRef}
            {...rest}
...
export function OTPInput(props: IOTPInputProps) {
    ...
    return (
        <div
            {...rest}
            className={twMerge(
                "flex w-full justify-between max-w-xs",
                className
            )}
        >
            {Array(length)
