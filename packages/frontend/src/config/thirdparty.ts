...
export const WALLET_CONNECT = {
    PROJECT_ID: process.env.REACT_APP_WALLET_CONNECT_PROJECT_ID ?? "",
} as const;

export const UNISWAP = {
    convenienceFee: process.env.REACT_APP_SWAP_FEE
        ? parseInt(process.env.REACT_APP_SWAP_FEE, 10)
        : undefined,
    convenienceFeeRecipient:
        process.env.REACT_APP_SWAP_FEE_ADDRESS || undefined,
} as const;
