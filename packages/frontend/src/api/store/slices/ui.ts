...
export interface IUIState {
    ...
    mobile: {
        ...
        lastInstallPrompt: number | undefined;
    };
...
const uiSlice = createSlice({
    ...
    reducers: {
        ...
        setLastInstallPrompt(draft, action: PayloadAction<number>) {
            draft.mobile.lastInstallPrompt = action.payload;
        },
    },
});
