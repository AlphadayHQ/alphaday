...
const staticCoins: Record<string, TRemoteCoin> = {
    ...
    "22": {
        ...
        description:
            "MANTRA (OM) is a cryptocurrency and operates on the Ethereum platform. MANTRA has a current supply of 1,794,271,244.72 with 944,191,679.1999999 in circulation. The last known price of MANTRA is 4.20267565 USD and is down -1.15 over the last 24 hours. It is currently trading on 219 active market(s) with $214,040,627.15 traded over the last 24 hours. More information can be found at https://www.mantrachain.io.",
        price: 7.25,
        max_supply: 0,
        circulating_supply: 0,
        total_supply: 0,
        market_cap: 7059386522,
        volume: 314542542.28781676,
        price_percent_change_24h: -4.551083004725353,
        rank: 24,
        // gecko_id: "mantra-dao",
        cmc_id: 6536,
        is_pinned: false,
