...
import Logoday from "../../assets/svg/logo-white.svg?react";

const Logo: FC = () => {
    return (
        <div className="two-col:pl-5 order-1 mr-0 flex two-col:w-[170px] items-center whitespace-nowrap pl-4 leading-[inherit]">
            <a
                href="/"
