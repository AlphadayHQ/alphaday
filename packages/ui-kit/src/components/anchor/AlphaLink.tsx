...
export const AnchorElement: FC<IAnchor> = ({
    ...
    <a
        ...
        className={twMerge(
            className,
            "text-primaryVariant100 fontGroup-highlightSemi hover:text-btnRingVariant100 active:text-btnBackgroundVariant1400 cursor-pointer hover:underline active:underline"
        )}
        href={path}
        target={target}
        onClick={onClick}
