export const darkColors = {
    ...
    primaryVariant300: "var(--alpha-primary-300)", // rgba(118, 124, 143, 0.2) -- primary dark grey opacity 0.2
    borderLine: "var(--alpha-border)", // #3b3a3a -- border
    background: "var(--alpha-dark-base)", // #121212 -- background
    backgroundVariant100: "var(--alpha-base-100)", // #191919 -- background variant 100
    ...
    secondaryOrange50: "var(--alpha-orange-50)", // #E1B74F
