...
interface IProps extends IBaseProps, LayoutProps, SpaceProps {
...
export const StyledAvatar = styled(({ display, mr, ...rest }: IProps) => (
  <div {...rest} />
))<IProps>`
  position: relative;
  ${({ $size }) =>
    ...
    css`
      &:after {
        box-shadow: 0 0 0 1.5px
          ${tinycolor(props.theme.colors.gray900).darken(5).toString()};
      }
    `}
  ${(props) =>
    props.theme.name === "dark" &&
